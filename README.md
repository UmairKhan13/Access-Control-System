...
- Name: `Access-Control`
- Directory to contain the project: `Access-Control`
...
- [Creates 3 users](/server/boot/sample-models.js#L12-L17) (`Umair`, `Mujtaba`, and
  `Moeiz`)
- [Creates project 1, sets `Umair` as the owner, and adds `Umair` and `Mujtaba` as team
  members](/server/boot/sample-models.js#L21-L39)
- [Creates project 2, sets `Mujtaba` as the owner and solo team
  member](/server/boot/sample-models.js#L41-L59)
- [Creates a role named `admin` and adds a role mapping to make `Moeiz` an
